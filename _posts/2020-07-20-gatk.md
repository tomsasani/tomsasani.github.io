...
Now that we've collected the various files we need, we can run VQSR.
...
- we *must* provide a file for VQSR to output tranche information to (`--tranches-file`)
...
gatk VariantRecalibrator \
	...
	--java-options "-Xmx8G" \
	--tranches-file /net/harris/vol1/data/bell_sc_sperm_seq_nobackup/{wildcards.sample}.tranches \
