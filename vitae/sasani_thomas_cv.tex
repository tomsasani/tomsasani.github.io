...
\homepage{http://tomsasani.github.io}                % optional, remove the line if not wanted
...
\cventry{8/11-6/15}{BA, Biochemistry}{Lawrence University}{Appleton, WI}{\emph{summa cum laude}}{}
\cvline{advisor:}{\small Professor Brian Piasecki}


\section{Experience}

\cventry{5/21-pres.}{Senior Data Scientist}{Recursion Pharmaceuticals}{}{}{
\begin{itemize}
\item Developing new computational methods to analyze data from massive cellular imaging experiments
\item Collaborating with product managers and scientists to disseminate results to wide audiences
\item Leading regular sprint planning sessions and delegating project goals to teams of ICs
\end{itemize}
}
...
\begin{itemize}
\item Analyzed whole-genome sequencing data from large CEPH/Utah families to identify
post-zygotic mosaicism and variability in human germline mutation rates
\item Used the Oxford Nanopore Technologies platform to sequence and analyze the genome
content of DNA viruses under strong selective pressure during experimental evolution
\end{itemize}
}
...
\item Constructed an automated worm tracking instrument to identify behavioral defects
in \emph{C. elegans}
\end{itemize}
}
...
\cvline{2020}{Fixsen SM, Cone KR, Goldstein SA, \textbf{Sasani TA}, Quinlan AR, Rothenburg S, Elde NC. Poxviruses capture host genes by LINE-1 retrotransposition. \Colorhref{https://www.biorxiv.org/content/10.1101/2020.10.26.356402v1.abstract}{\emph{bioRxiv}}.}
